...
| D8 | export | ✅ | 0.3s |
| D7b | run --with | ❌ | 5.9s |
| D2b | lock --upgrade | ✅ | 3.5s |
| D3b | sync --frozen | ✅ | 0.2s |
| D9 | init --lib | ✅ | 0.1s |
| D10 | init --script | ✅ | 0.2s |
| D11 | add --script | ✅ | 0.3s |
| D12 | run script.py | ✅ | 0.4s |
| D13 | run -m module | ❌ | 0.1s |
| D14 | init --app | ✅ | 0.1s |
| D15 | add --optional | ✅ | 1.3s |
| D16 | add --group | ✅ | 4.1s |
