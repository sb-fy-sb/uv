...
| D8 | export | ❌ | 0.3s |
| D7b | run --with | ❌ | 0.4s |
| D2b | lock --upgrade | ❌ | 0.4s |
| D3b | sync --frozen | ❌ | 0.4s |
| D9 | init --lib | ✅ | 0.1s |
| D10 | init --script | ✅ | 0.3s |
| D11 | add --script | ❌ | 0.5s |
| D12 | run script.py | ❌ | 0.5s |
| D13 | run -m module | ❌ | 0.4s |
| D14 | init --app | ✅ | 0.1s |
| D15 | add --optional | ❌ | 0.4s |
| D16 | add --group | ❌ | 0.4s |
