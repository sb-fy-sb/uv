...
| D13 | run -m module | ⏭️ | - |
| D14 | init --app | ✅ | 0.1s |
| D15 | add --optional | ✅ | 1.2s |
| D16 | add --group | ✅ | 4.2s |
| D17 | add --editable | ✅ | 0.3s |
| D18 | sync --no-dev | ✅ | 0.3s |
| D19 | export pylock.toml | ✅ | 0.2s |
