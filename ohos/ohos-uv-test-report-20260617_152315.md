...
| C3c | pip list --outdated | ✅ | 0.5s |
| C8 | pip uninstall urllib3 | ✅ | 0.3s |
| C8b | pip uninstall requests | ✅ | 0.2s |
| C9 | pip compile | ✅ | 0.3s |
| C9b | pip sync | ✅ | 0.3s |
| C18 | pip install -r | ✅ | 0.3s |
| C19 | pip install --upgrade | ✅ | 0.6s |
| C20 | pip install --no-deps | ✅ | 0.2s |
| C21 | pip install -e | ✅ | 0.2s |
| C22 | pip uninstall -r | ✅ | 0.3s |
| D1 | init 项目 | ✅ | 0.1s |
| D2 | lock | ✅ | 0.2s |
| D3 | sync | ✅ | 0.3s |
| D4 | add 依赖 | ✅ | 0.8s |
